...
def perform(input_csv: pd.DataFrame, band_index: int, interpolation_points: list):
    r"""
...
#
# display(input_csv=csv, pixel_index=index, name_of_band=band_name, do_interpolate=False, apply_filter=False,
